...
<form class="form-group" id="authorsForm" >

        <h1 class="text-center">Create Authors</h1><br><br>
...
<div class="button1">
    ...
    <a href="{{url('/authors')}}" class="btn btn" style="background-color:#001f4d!important; color:white;width:140px;font-family:'Trebuchet MS', sans-serif; ">Back</a>
</div>
...
$(document).ready(function(){
    $('#saveButton').click(function (e) {
	    ...
	    var data = {
            formdata: $('#authorsForm').serialize()
        }
